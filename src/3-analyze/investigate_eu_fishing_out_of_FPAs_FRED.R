...
fig_save_path <- "output/figures/eu_fishing_without_authorisation/FRED/"
...
eu_fishing_in_agreements <- read_csv("output/data/gfw_apparent_fishing_effort/gfw_effort_EU_vessels_within_FPA_authorisations_DAILY_2022-2024_FRED.csv")
eu_fishing_out_of_agreements <- read_csv("output/data/gfw_apparent_fishing_effort/gfw_effort_EU_vessels_out_of_FPA_authorisations_DAILY_2022-2024_FRED.csv")
